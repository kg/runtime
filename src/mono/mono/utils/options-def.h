...
DEFINE_INT(jiterpreter_trace_monitoring_period, "jiterpreter-trace-monitoring-period", 500, "Monitor jitted traces for this many calls to determine whether to keep them")
// traces that bail out frequently after only executing this many opcodes will be rejected
DEFINE_INT(jiterpreter_trace_average_opcodes_threshold, "jiterpreter-trace-average-opcodes-threshold", 6, "Traces with an average distance less than this will be discarded")
