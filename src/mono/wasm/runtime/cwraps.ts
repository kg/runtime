...
const fn_signatures: [ident: string, returnType: string | null, argTypes?: string[], opts?: any][] = [
    ...
    ["mono_wasm_array_info_ref", "void", ["number", "number", "number", "number", "number"]],
    ["mono_wasm_memcpy_from_managed_object", "void", ["number", "number", "number", "number", "number", "number"]],
    ["mono_wasm_copy_managed_pointer_from_field", "void", ["number", "number", "number"]],
    ["mono_wasm_get_object_field_i32", "number", ["number", "number"]],
    ["mono_wasm_get_object_field_f64", "number", ["number", "number"]],
