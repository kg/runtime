...
namespace Internal.JitInterface
{
    internal unsafe partial class CorInfoImpl
    {
        private struct ICorJitInfoCallbacks
        {
            ...
            public delegate* unmanaged<IntPtr, IntPtr*, CorInfoType*, nuint, CORINFO_WASM_TYPE_SYMBOL_STRUCT_*> getWasmTypeSymbol;
        ...
        [UnmanagedCallersOnly]
        private static CORINFO_WASM_TYPE_SYMBOL_STRUCT_* _getWasmTypeSymbol(IntPtr thisHandle, IntPtr* ppException, CorInfoType* types, nuint typesSize)
        {
            var _this = GetThis(thisHandle);
            try
            {
